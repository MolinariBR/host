...
export async function listServicesController(_request, reply) {
    const items = await servicesService.listServices(prisma);
    return reply.code(200).send({ items });
}
export async function createServiceController(request, reply) {
...
export async function updateServiceController(request, reply) {
    ...
    try {
        const updated = await servicesService.updateService(prisma, parsedParams.data.serviceId, parsedBody.data);
...
export async function deleteServiceController(request, reply) {
